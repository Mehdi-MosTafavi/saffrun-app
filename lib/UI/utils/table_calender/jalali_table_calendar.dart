  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        late BoxDecoration decoration = const BoxDecoration();
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    GestureDetector(
                      child: Text("${pdate.monthname}  ${pdate.year}",
...
class _CalendarMonthPickerState extends State<CalendarMonthPicker>
  ...
  void _updateCurrentDate() {
    ...
    // if(_timer!=null)// so we don't miss it by rounding
    //   _timer.cancel();
...
class _DatePickerCalendarState extends State<_DatePickerCalendar> {
  ...
  late DatePickerModeCalendar _mode;
